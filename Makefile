...
hl7_con.o: $(SRCPATH)hl7_con.c $(SRCPATH)hl7_api.h $(SRCPATH)hl7_con.h $(SRCPATH)iniparser.h $(SRCPATH)pttype.h
	$(CC) $(CFLAGS) $(SRCPATH)hl7_con.c

decode.o: $(SRCPATH)decode.c $(SRCPATH)decode.h $(SRCPATH)pttype.h
